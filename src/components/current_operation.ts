...
export class CurrentOperationComponent extends MobxLitElement {
    ...
    override render():TemplateResult {
        ...
        if (currentStep instanceof ChoiceStep){
            return html`
            <dm-choices .choiceStep=${currentStep}></dm-choices>
            `
        }
    ...
    renderControlsStep(currentStep: ControlsStep):TemplateResult{
        ...
        const subtitle = currentStep.subtitle? html`<div class="controls-step-subtitle">${currentStep.subtitle}</div>`: html``;
