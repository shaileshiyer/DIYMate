...
import { GenerateIntroductionPromptParams } from "@core/shared/interfaces";
...
export function makePromptHandler(model: OpenAIModel, context: DIYMateContext){
    ...
    function generatePrompt(
        ...
        let content = `${prefix} ${model.wrap(DIYWithBlank)}\n Generate an introduction for this DIY Tutorial:`;
    ...
    return async function generateIntroduction(params:GenerateIntroductionPromptParams) {
